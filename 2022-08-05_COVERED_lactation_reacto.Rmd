...
data_use <- data_use %>% 
  mutate(include_BL = case_when(
    ...
    dose1_T == "D1 during preg" & dose2_T == "D2 during preg" & dose3_T == "D3 during preg" ~ "exclude",
    dose1_T == "D1 during preg" & dose2_T == "D2 during preg" ~ "exclude",
    dose1_T == "D1 during preg" ~ "exclude",
...
```{r plot people over time by vaxx NOT USED}
...
### of those vaccinated in pp
data_vaxPP <- data[which(data$vacc_in_pp == "pp vaccine"), ]
